mod performed_exercise;
mod performed_set;
mod performed_workout;
...
pub type MockModelResult<T> = core::result::Result<T, Error>;
...
impl User {
    ...
    pub async fn mocked(database: &DatabaseManager) -> MockModelResult<User> {
...
impl Profile {
    ...
    pub async fn mocked(database: &DatabaseManager) -> MockModelResult<Profile> {
...
impl ProfileBuilder<NoUserId, Birthday, UserGender> {
    pub async fn create(self, database: &DatabaseManager) -> MockModelResult<Profile> {
...
impl MuscleGroup {
    ...
    pub async fn mocked(database: &DatabaseManager) -> MockModelResult<MuscleGroup> {
...
impl Muscle {
    ...
    pub async fn mocked(database: &DatabaseManager) -> MockModelResult<Muscle> {
...
impl MuscleBuilder<NoMuscleGroupId, MuscleName> {
    pub async fn create(self, database: &DatabaseManager) -> MockModelResult<Muscle> {
...
impl ExerciseEquipment {
    ...
    pub async fn mocked(database: &DatabaseManager) -> MockModelResult<ExerciseEquipment> {
...
impl Exercise {
    ...
    pub async fn mocked(database: &DatabaseManager) -> MockModelResult<Exercise> {
...
impl ExerciseInstruction {
    ...
    pub async fn mocked(database: &DatabaseManager) -> MockModelResult<ExerciseInstruction> {
...
impl ExerciseInstructionBuilder<NoExerciseId, SequenceNumber, Content> {
    pub async fn create(self, database: &DatabaseManager) -> MockModelResult<ExerciseInstruction> {
...
impl ExerciseMuscleMap {
    ...
    pub async fn mocked(database: &DatabaseManager) -> MockModelResult<ExerciseMuscleMap> {
...
impl ExerciseMuscleMapBuilder<NoExerciseIdMap, NoMuscleIdMap, ExerciseMuscleMapTarget> {
    pub async fn create(self, database: &DatabaseManager) -> MockModelResult<ExerciseMuscleMap> {
...
impl Link {
    ...
    pub async fn mocked(database: &DatabaseManager) -> MockModelResult<Link> {
...
impl LinkBuilder<NoLinkModelData, LinkTypeEnum, LinkFormatEnum, LinkLabel, LinkSrc> {
    pub async fn create(self, database: &DatabaseManager) -> MockModelResult<Link> {
