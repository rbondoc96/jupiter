    ...
    return (
        <DayPicker
            ...
            classNames={{
                ...
                dropdown: 'border border-input text-sm bg-background rounded-md',
                caption_dropdowns: 'flex gap-x-2',
                vhidden: 'hidden',
                ...classNames,
            }}
            components={{
                IconLeft: () => <FontAwesomeIcon className="h-4 w-4" icon={faChevronLeft} />,
                IconRight: () => <FontAwesomeIcon className="h-4 w-4" icon={faChevronRight} />,
            }}
            {...props}
        />
    );
