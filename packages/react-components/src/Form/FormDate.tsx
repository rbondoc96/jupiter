...
import { composeClassName, DateTimeFormat } from '@jupiter/web';
...
import { FormFieldPrimitive, type FormFieldPrimitiveClassNames, PopoverPrimitive } from '@jupiter/react-primitives';

export type FormDateClassNames = FormFieldPrimitiveClassNames &
    Partial<{
                        ...
                        <div className="relative" ref={inputContainerRef}>
                            <PopoverPrimitive.Anchor>
                                <input
                                    ...
                                    value={
                                        field.value && (field.value as unknown) instanceof Date
