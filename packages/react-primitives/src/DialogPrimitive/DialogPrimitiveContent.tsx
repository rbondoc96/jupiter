...
import { DialogPrimitiveOverlay } from './DialogPrimitiveOverlay';
...
type DialogPrimitiveContentProps = ComponentPropsWithoutRef<typeof Content> & VariantProps<typeof dialogVariants>;

export const DialogPrimitiveContent = forwardRef<ElementRef<typeof Content>, DialogPrimitiveContentProps>(
    ({ children, className, side = 'right', ...props }, ref) => (
        <Portal>
            <DialogPrimitiveOverlay />
            <Content ref={ref} className={composeClassName(dialogVariants({ side }), className)} {...props}>
                {children}
                <Close
